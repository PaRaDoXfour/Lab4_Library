...
public class Audiobook extends Book {
     ...
     */
    public Audiobook(String title, String author, int year, String isbn,
                     int page, Genre genre, double duration,
                     String narrator) throws GenreException,
            YearException, PagesException, AuthorException,
            TitleException, IsbnException, DurationException,
            NarratorException {
    ...
    public String toString() {
        return "Аудіо " + super.toString() + String.format(", "
                + "Тривалість: %.1f год., Диктор: %s", duration, narrator);
    }
